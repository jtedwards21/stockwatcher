...
　　　　　　　　　　　　</div>
	    ...
	    　　<TickerWidgets initialData={this.props.initialData}　tickers={["AAPL"]} startDate={this.state.startDate} endDate={this.state.endDate} />
...
ReactDOM.render(
  <Grapher initialData={initialData} tickers={['AAPL']} startDate={'2016-05-05'} endDate={"2016-11-10"} />,
